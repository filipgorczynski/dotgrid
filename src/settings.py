...
class Settings:
    ...
    def __init__(self):
        self.filename = "DotGridPage"
        self.size = A4  # check the default setting below
        self.xgap = .5  # in cm
        self.ygap = .5  # in cm
        self.footer = "Copyright © 2018 Filip Górczyński"

        # Minor line setting:
        self.colorMinor = dimgray  # check the default setting below
        self.lineWidthMinor = 1

        # Major line setting:
        # if u dont want the major grid, set the majorLine=False
        self.majorLine = True
        self.colorMajor = dimgray  # check the default setting below
